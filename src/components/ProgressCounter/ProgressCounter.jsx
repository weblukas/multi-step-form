...
const ProgressCounter = () => {
    return (
        ...
        <div className={style.pcContainer}>
            ...
            <img src="ellipse2.png" alt="" className={`${style.ellipse} ${style.ellipse4}`}/>
            <img src="ellipse2.png" alt="" className={`${style.ellipse} ${style.ellipse5}`}/>
            ...
            <span className={`${style.stepCounter} ${style.stepCounter4}`}>4</span>
            <span className={`${style.stepCounter} ${style.stepCounter5}`}>5</span>
        </div>
        </>
    );
};
